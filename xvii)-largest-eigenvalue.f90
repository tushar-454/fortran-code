program largest_eigenvalue
    ...
    ! Define the matrix A
    A(1,1) = 5.0d0;  A(1,2) = 0.0d0;  A(1,3) = 1.0d0
    A(2,1) = 0.0d0;  A(2,2) = -2.0d0;  A(2,3) = 0.0d0
    A(3,1) = 1.0d0;  A(3,2) = 0.0d0;  A(3,3) = 5.0d0
    ...
    print *, "FINAL RESULTS:"
    print *, "================================="
    print '(A,F12.8)', "Largest Eigenvalue = ", eigenvalue
...
end program largest_eigenvalue